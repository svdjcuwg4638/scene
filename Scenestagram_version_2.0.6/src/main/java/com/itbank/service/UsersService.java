...
public class UsersService {	
	...
	public int profileImgModify(String originalFilename, int userIdx) {
		HashMap<String, Object> hashmap = new HashMap<String, Object>();
		hashmap.put("userimg", originalFilename);
		hashmap.put("idx",userIdx);
		return usersDAO.updateuser_img(hashmap);
	}
}
